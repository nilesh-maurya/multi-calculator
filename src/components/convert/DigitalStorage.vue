<template>
  <div class="digital wrapper-convert-element">
...
export default {
  ...
  data() {
    return {
      toggleFocus: true,
      select1: { unit: "Bits", abbr: "b" },
      select2: { unit: "Bytes", abbr: "B" },
      items: [
        { unit: "Bits", abbr: "b" },
        { unit: "Kilobit", abbr: "Kb" },
        { unit: "Megabit", abbr: "Mb" },
        { unit: "Gigabit", abbr: "Gb" },
        { unit: "Terabit", abbr: "Tb" },
        { unit: "Byte", abbr: "B" },
        { unit: "Kilobyte", abbr: "KB" },
        { unit: "Megabyte", abbr: "MB" },
        { unit: "Gigabyte", abbr: "GB" },
        { unit: "Terabyte", abbr: "TB" }
      ]
    };
  },
  computed: {
  ...
  methods: {
    handleInput(key) {
      ...
      this.calculateDigitalStorage(id);
    },
    handleChange(id) {
    ...
    calculateDigitalStorage(id) {
      // find conversion here
      let convertedValue;
      if (id === "1") {
        convertedValue = convert(this.first_input, "digital")
          .from(this.select1.abbr)
          .to(this.select2.abbr);

        mutations.setSecondInput(convertedValue.toString(10));
      } else if (id === "2") {
        convertedValue = convert(this.second_input, "digital")
